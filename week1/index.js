...
const courseName = "14堂組合包方案";
let coursePrice = 2520;
const courseNumber = 14;
const courseMinutes = 50;
let courseAvgPrice = 180;
const discount = 0.9;
...
let b = 0; // 宣告變數為 b，並賦值為數字型別為 0
a = 13; // 將變數 a 重新賦值為數字型別為 13
a = b + 4; //取得變數 b 值為 0 ，與數字 4 相加，結果為數字 4，將變數 a 重新賦值數字型別為 4
a - b; //取得變數 a 值為 4，取得變數 b 值為 0，執行相減 4 - 0
b += 1; //取得變數 b 值為 0，與數字 1 相加，結果為數字 1，將變數 b 重新賦值數字型別為 1
// a = 4 ， b = 1
