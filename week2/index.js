...
var l = '8';
// 請文字解釋為什麼
console.log(k * l > 21); // k * l 得 24 (l '8' 字串遇數字自動轉型), 24 > 21 得 true
...
// 練習：計算教練業績獎金
let bonusRate = 0.1; // 基本獎金為 10%
if (coachIncome > 100000 && coachIncome <= 300000) 
  bonusRate = 0.15; // 條件三：全年業績超過 10 萬 ~ 30 萬以下者，給 15% 獎金
if (coachIncome > 300000 ) 
  bonusRate = 0.2; // 條件四：全年業績超過 30 萬者，給 20% 獎金

coachBonus = coachIncome * bonusRate + 6000;
...
if (playerA === '剪刀') {
  if (playerB === '布') console.log("playerA 獲勝");
  else if (playerB === '石頭') console.log("playerB 獲勝");
}
if (playerA === '石頭') {
  if (playerB === '剪刀') console.log("playerA 獲勝");
  else if (playerB === '布') console.log("playerB 獲勝");
}
if (playerA === '布') {
  if (playerB === '石頭') console.log("playerA 獲勝");
  else if (playerB === '剪刀') console.log("playerB 獲勝");
}
...
// 練習：計算小明今日消耗的卡路里
calorieBurn += activities.bicycle.calorieBurnPerMin * 10
calorieBurn += activities.treadmill.calorieBurnPerMin * 30
